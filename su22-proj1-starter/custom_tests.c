...
bool test_body_to_tail() {
  ...
  char *convert = "wasd";
  for(int i = 0; i < strlen(test); i++)
    if(convert[i] != body_to_tail(test[i]))
      return false;
  return true;
}
...
bool test_head_to_body() {
  ...
  char *convert = "^<v>";
  for(int i = 0; i < strlen(test); i++)
    if(convert[i] != head_to_body(test[i]))
      return false;
  return true;
}
...
bool test_get_next_x() {
  // TODO: Implement this function.
  char *test = "wasd^<v>WASD";
  unsigned int x = 1;
  unsigned int x_new[] = {1,0,1,2,1,0,1,2,1,0,1,2};
  for(int i = 0; i < strlen(test); i++)
    if(get_next_x(x , test[i]) != x_new[i])
      return false;
  return true;
}
...
bool test_get_next_y() {
  ...
  char *test = "wasd^<v>WASD";
  unsigned int y = 1;
  unsigned int y_new[] = {0,1,2,1,0,1,2,1,0,1,2,1};
  for(int i = 0; i < strlen(test); i++)
    if(get_next_y(y , test[i]) != y_new[i])
      return false;
  return true;
}
